        ...
        <Card
          title={
            <span className={styles.cardTitle}>
              ...
              {t('auth_login.kiro_oauth_title', { defaultValue: 'Kiro OAuth' })}
            </span>
          }
          extra={
            <Button onClick={() => window.location.href = '/v0/oauth/kiro'}>
              {t('common.login')}
            </Button>
          }
        >
          <div className="hint">
            {t('auth_login.kiro_oauth_hint', { defaultValue: 'Login with Kiro OAuth to authenticate your account.' })}
          </div>
        </Card>
